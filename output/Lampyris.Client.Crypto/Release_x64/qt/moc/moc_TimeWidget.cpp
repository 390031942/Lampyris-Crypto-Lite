...
#include "../../../../../Lampyris.Client.Crypto/sources/UI/Common/TimeWidget.h"
...
static constexpr auto qt_meta_stringdata_ZN10TimeWidgetE = QtMocHelpers::stringData(
    "TimeWidget",
    "updateTime",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10TimeWidgetE[] = {
...
Q_CONSTINIT const QMetaObject TimeWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10TimeWidgetE.offsetsAndSizes,
    qt_meta_data_ZN10TimeWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10TimeWidgetE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TimeWidget, std::true_type>,
        // method 'updateTime'
...
void *TimeWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10TimeWidgetE.stringdata0))
