...
#include "../../../../../Lampyris.Client.Launcher/sources/LauncherWidget.h"
...
static constexpr auto qt_meta_stringdata_ZN14LauncherWidgetE = QtMocHelpers::stringData(
    "LauncherWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN14LauncherWidgetE[] = {
...
Q_CONSTINIT const QMetaObject LauncherWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14LauncherWidgetE.offsetsAndSizes,
    qt_meta_data_ZN14LauncherWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14LauncherWidgetE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<LauncherWidget, std::true_type>
    >,
    nullptr
} };
...
void *LauncherWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14LauncherWidgetE.stringdata0))
